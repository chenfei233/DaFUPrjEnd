...
//	static String PDF2HTMLCOMMAND = "pdf2htmlEX --no-drm 1 --embed-image 1 --dest-dir ";
	 ...
	 */
	 public static String getFileName(String filename) { 
		 ...
		 File f =new File(strFileName[strFileName.length-1]);  
	     String fileName=f.getName();  
	     String prefix=fileName.substring(fileName.lastIndexOf("."));
	     int num=prefix.length();//得到后缀名长度  
	     filename=fileName.substring(0, fileName.length()-num);//得到文件名。去掉了后缀
	     return filename; //数组最后一个内容就是你要的文件名了
	 } 
	 ...
	 **@date:  20170701
	 */
	public static String  PPT2PDF(String ppt, String outputpath){
	       ...
	       String pdfRstPath = null; 
	        try {
	          ...
	          //           .buildOfficeManager();
	            ...
	            //方式二  
	            File directory = new File(/*"ppt2pdf_output"*/outputpath);			//设定为当前文件夹  
	            ...
	            logger.info("pdfaddr =" + pdfRstPath);
    ...
    public static boolean PDF2HTML(String pdfName, String outputPath){  
        ...
        try {  
            ...
            /* 下面是把html转换成md文件 */
            String inputstr=getFileNameNoEx(pdfName)+".html";//转换后的html文件路径
            String[] cmds={inputstr,outputPath};
            App.DaFuPrj(cmds);//转换md
	 ...
	 **@date:  20170701
	 */
	public static String  DOC2PDF(String doc, String outputPath){
		   OfficeManager officeManager = null;
	       Integer result=-1;
	       ConfRW.init_config("conf/dafu.properties");
	       String officeHome = null;
	       ...
	       String pdfRstPath = null; 
	        try {
	            ...
	            //方式二  
	            File directory = new File(outputPath/*"doc2pdf_output"*/);			//设定为当前文件夹  
	        	String strRootPath = directory.getCanonicalPath();		//获取标准的路径  
	            ...
	            logger.info("pdfaddr =" + pdfRstPath);
	        	File pdfRst = new File(strRootPath + File.separator + fileNameNoEx + ".pdf");
	            converter.convert(new File(doc), pdfRst);        
